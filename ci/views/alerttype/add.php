	...
	<?php }
	$attributes = array('class' => 'form', 'id' => 'add-alerttype');
	echo form_open(site_url('alerttypes/add'), $attributes);
	?>
	<div class='row'>
	<h2 class='text-center'><?php echo $this->lang->line('alerttype');?></h2>
		<div class='form-group col-lg-12 col-md-12 col-sm-12 col-xs-12'> 
        	...
        	<input type='text' class='form-control' name='alerttype_name' id='alerttype_name' required />
    	</div> 
	</div>
	<div class='row'>
		...
		<div class='form-group col-lg-6 col-md-6 col-sm-6 col-xs-12'>
			<button class='btn btn-primary form-control' name='new_alerttype' id='new_alerttype'>Αποθήκευση</button>
		</div>
	</div>
	<?php echo form_close() ?>
