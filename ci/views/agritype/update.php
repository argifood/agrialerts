	...
	<?php }
	$attributes = array('class' => 'form', 'id' => 'update-agritype');
	echo form_open(site_url('agritypes/update/'.$row['agritype_id']), $attributes);
	?>
	<div class='row'>
	<h2 class='text-center'><?php echo $this->lang->line('agritype');?></h2>
        ...
        <input type='text' class='form-control' name='agritype_name' id='agritype_name' value='<?php echo $row['agritype_name'] ?>'required />
      </div> 
