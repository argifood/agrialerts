	...
	<?php }
	$attributes = array('class' => 'form', 'id' => 'add-nuts3');
	echo form_open(site_url('nuts3s/add'), $attributes);
	?>
	<div class='row'>
	<h2 class='text-center'><?php echo $this->lang->line('nuts3');?></h2>
        ...
        <input type='text' class='form-control' name='nuts3_name' id='nuts3_name' required />
      </div> 
<div class='form-group col-lg-6 col-md-6 col-sm-6 col-xs-12'> 
	...
	<div class='row'>
		...
		<div class='form-group col-lg-6 col-md-6 col-sm-6 col-xs-12'>
			<button class='btn btn-primary form-control' name='new_nuts3' id='new_nuts3'>Αποθήκευση</button>
		</div>
	</div>
	<?php echo form_close() ?>
