	...
	<?php }
	$attributes = array('class' => 'form', 'id' => 'update-agency');
	echo form_open(site_url('agencies/update/'.$row['agency_id']), $attributes);
	?>
	<div class='row'>
	<h2 class='text-center'><?php echo $this->lang->line('agency');?></h2>
        ...
        <input type='text' class='form-control' name='agency_name' id='agency_name' value='<?php echo $row['agency_name'] ?>'required />
      </div> 
<div class='form-group col-lg-6 col-md-6 col-sm-6 col-xs-12'> 

        <label class='control-label' for='agency_address'><?php echo $this->lang->line('agency_address') ?></label>
        <input type='text' class='form-control' name='agency_address' id='agency_address' value='<?php echo $row['agency_address'] ?>'required />
      </div> 
<div class='form-group col-lg-2 col-md-2 col-sm-2 col-xs-12'> 

        <label class='control-label' for='agency_zip'><?php echo $this->lang->line('agency_zip') ?></label>
        <input type='text' class='form-control' name='agency_zip' id='agency_zip' value='<?php echo $row['agency_zip'] ?>'required />
      </div> 
<div class='form-group col-lg-3 col-md-3 col-sm-3 col-xs-12'> 

        <label class='control-label' for='agency_city'><?php echo $this->lang->line('agency_city') ?></label>
        <input type='text' class='form-control' name='agency_city' id='agency_city' value='<?php echo $row['agency_city'] ?>'required />
      </div> 
